 ...
 */
bool isDigit(const std::string &input, const bool checkNumPhone) {
 ...
 */
std::string checkName(const std::string &input) {
    std::string result = "";
 ...
 */
std::string checkDate(const std::string &input) {
    std::string result = "";
    if (input.size() == 10) {
        const std::vector<std::string> date = splitString(input, ".");
 ...
 */
int checkPayment(const std::string &input) {
    int result;
    try {
        result = stoi(input);
    } catch (...) {
