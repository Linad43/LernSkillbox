 ...
 */
int selectOrderNotRepetition(const int n, const int m) {
    if (m > n) {
        return -1; //exception
    }
 ...
 */
int selectOrderRepetition(const int n, const int m) {
    if (m > n) {
        return -1; //exception
    }
    return pow(n, m);
 ...
 * A_m^n = ab, ac, bc = 3
 */
int selectNotOrderNotRepetition(const int n, const int m) {
    if (m > n) {
        return -1; //exception
    }
 ...
 */
int selectNotOrderRepetition(const int n, const int m) {
    if (m > n) {
        return -1; //exception
    }
